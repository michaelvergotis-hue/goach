    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6 md:px-8">
      <div className="w-full max-w-sm md:max-w-md">
        ...
        <button
          ...
          className="w-full bg-card hover:bg-card-hover border border-border text-foreground font-semibold py-4 rounded-xl transition-colors flex items-center justify-center gap-3"
        >
          {isSigningIn ? (
